(function e(t, n, r) {
    ...
    }, { "./contract": 10, "./game-state": 16, "./i18n": 24, "./trade-offer": 45 }],
    ...
    }, { "./contract": 10, "./i18n": 24, "./symbols": 42, "./text-wrapper": 43 }],
    3: [function(require, module, exports) {
        (function() {
            ...
            function standardProperties() {
                ...
                var companyGroup = PropertyGroup.companyGroup(9, ' lightgreen', groupMembers, { value: 150, multipliers: [4, 10] });
    ...
    }, { "./contract": 10, "./i18n": 24, "./property": 39, "./property-group": 38 }],
    ...
    }, { "./fail-fast": 12, "./game-task": 17, "./game-widget": 18 }],
    ...
    }, { "./contract": 10, "./game-state": 16, "./i18n": 24, "./property": 39 }],
    ...
    }, { "./choices": 7, "./contract": 10, "./game-state": 16, "./i18n": 24, "./player": 35 }],
    ...
    }, { "./contract": 10, "./go-bankrupt-choice": 19, "./pay-rent-choice": 31, "./pay-tax-choice": 32, "./player": 35 }],
    ...
    }, { "./choices": 7, "./contract": 10, "./game-state": 16, "./i18n": 24 }],
    ...
    }, { "./contract": 10, "./game-state": 16, "./i18n": 24 }],
    ...
    }, { "./accept-offer-choice": 1, "./board": 3, "./buy-property-choice": 5, "./calculate-dice-rent-choice": 6, "./choices": 7, "./choose-tax-type-choice": 8, "./contract": 10, "./finish-turn-choice": 13, "./go-to-jail-choice": 20, "./move-choice": 29, "./pay-deposit-choice": 30, "./reject-offer-choice": 40, "./trade-choice": 44, "./trade-offer": 45, "./try-double-roll-choice": 48 }],
    ...
    }, { "./board": 3, "./configure-game-task": 9, "./play-game-task": 33 }],
    ...
    }, { "./contract": 10, "./game-configuration-widget": 15, "./monopoly-game-widget": 28 }],
    ...
    22: [function(require, module, exports) {
        (function() {
            ...
            exports.CONFIGURE_GAME_TITLE = 'YearUpoly - game configuration';
            ...
            exports.CHOICE_GO_TO_JAIL = "Meeting with Staff";
            exports.CHOICE_PAY_DEPOSIT = "Pay a {money} Points to leave Meeting with Staff";
            exports.CHOICE_TRY_DOUBLE_ROLL = "Try to roll a double get out of Meeting with Staff";
            ...
            // Squares
            exports.CHANCE = 'Monday Morning';
            exports.COMMUNITY_CHEST = 'Friday feedback';
            exports.INCOME_TAX = 'Infaction';
            exports.LUXURY_TAX = 'Late to Class';
            exports.LUXURY_TAX_DESCRIPTION = "Pay $75";
            exports.INCOME_TAX_DESCRIPTION = "Pay 10% or $200";
            exports.START_DESCRIPTION = "Collect 200 Points as you pass";
            exports.VISITING_JAIL = "Status Update";
            exports.FREE_PARKING = "No classes";
            exports.GO_TO_JAIL = "Meeting with Staff";

            exports.COMPANY_WATER = 'Application development';
            exports.COMPANY_ELECTRIC = "Quality assurance";

            exports.RAILROAD_READING = 'Mid-Town';
            exports.RAILROAD_PENN = 'Up-town';
            exports.RAILROAD_B_O = 'Down-Town';
            exports.RAILROAD_SHORT = 'Puget-Sound';

            exports.PROPERTY_MD = 'Accenture';
            exports.PROPERTY_BT = 'Alaska Air';
            exports.PROPERTY_ET = "Bank of America";
            exports.PROPERTY_VT = 'Bungie';
            exports.PROPERTY_CN = 'CointStar';
            exports.PROPERTY_CL = 'DocuSign';
            exports.PROPERTY_US = 'SalesForce';
            exports.PROPERTY_VN = 'Slalom LLC';
            exports.PROPERTY_JK = 'CaptiolOne';
            exports.PROPERTY_TN = 'Nordstrom';
            exports.PROPERTY_NY = 'Tableau Software';
            exports.PROPERTY_KT = 'E*Trade';
            exports.PROPERTY_IN = 'United Airlines';
            exports.PROPERTY_IL = 'PayPal';
            exports.PROPERTY_AT = 'Expidia';
            exports.PROPERTY_VR = 'F5 Network';
            exports.PROPERTY_MN = 'AT&T';
            exports.PROPERTY_PA = 'Verizon';
            exports.PROPERTY_NC = 'J.P. Morgan Chase';
            exports.PROPERTY_PN = 'Meta';
            exports.PROPERTY_PK = 'Microsoft';
            exports.PROPERTY_BW = 'Amazon';
            ...
            exports.PLAYER_TYPE_COMPUTER = 'Super Computer A.I.';
    ...
    }, { "./contract": 10, "./i18n": 24, "./player": 35, "./property": 39, "./trade-offer": 45 }],
    ...
    }, { "./board-widget": 2, "./contract": 10, "./dice-widget": 11, "./game-choices-widget": 14, "./i18n": 24, "./log-game-widget": 26, "./players-widget": 36, "./trade-widget": 47 }],
    ...
    }, { "./contract": 10, "./game-state": 16, "./i18n": 24, "./player": 35 }],
    ...
    }, { "./board": 3, "./contract": 10, "./game-state": 16, "./handle-choices-task": 21, "./log-game-task": 25, "./player": 35, "./roll-dice-task": 41, "./trade-offer": 45, "./trade-task": 46 }],
    ...
    }, { "./contract": 10, "./i18n": 24, "./player-colors": 34, "./property": 39 }],
    ...
    }, { "./contract": 10, "./game-state": 16, "./i18n": 24, "./player": 35, "./trade-offer": 45 }],
    ...
    }, { "./contract": 10, "./player": 35, "./trade-offer": 45 }],
